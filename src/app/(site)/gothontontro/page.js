...
const SECTIONS = [
  ...
  { id: 4, color: "#7b2d8b", title: "ধারা ৪: সাধারণ সদস্য", items: [{ sub: "", body: "সাধারণ সদস্য কেবলমাত্র ২ (ক) ধারাতে সংজ্ঞায়িত নিশ্চিন্তপুর উচ্চ বিদ্যালয়ের ২০২১ সালের এসএসসি পরীক্ষার্থী শিক্ষার্থীদের জন্য নির্ধারিত থাকবে। যে কোন শিক্ষার্থী নামমাত্র রেজিস্ট্রেশন ফি বা সর্বনিম্ন ১০০ টাকা প্রদানপূর্বক সাধারণ সদস্য হতে পারিবেন।" }, { sub: "ধারা ৪.১: সাধারণ সদস্যদের অধিকার ও সুবিধা", body: "ক. বিধি মোতাবেক কার্যনির্বাহী কমিটির কর্মকাণ্ডের ব্যাখ্যা দাবি করা এবং আয়-ব্যয়ের হিসাব চাওয়া।\nখ. সংগঠনের যে কোন কমিটিতে নির্বাচনে অংশগ্রহণ করা।\nগ. ভোট প্রদান করা।\nঘ. সংগঠনের উন্নয়নের স্বার্থে পরামর্শদান বা নির্বাচন কমিশনে কাজ করা।\nঙ. কার্য নির্বাহী পরিষদ যদি তাদের দায়িত্ব যথাযথ পালন না করে তাহলে তাদের পদত্যাগের দাবি করতে পারবে।" }] },
  { id: 5, color: "#c77dff", title: "ধারা ৫: চাঁদা সম্পর্কিত", items: [{ sub: "", body: "১. সংগঠনে প্রদত্ত টাকা ব্যক্তিস্বার্থে ব্যবহার করা যাবে না এবং সংগঠনে প্রদত্ত টাকা পরবর্তীতে কেউ উত্তোলন বা নিজের দাবি করতে পারবে না।\n২. মাসিক চাঁদা প্রতি মাসের ১-১০ তারিখের মধ্যে পরিশোধ করা লাগবে।\n৩. বার্ষিক চাঁদা ক্যাশিয়ারের সাথে আলোচনা করে নির্দিষ্ট সময়ের মধ্যে পরিশোধ করা লাগবে।" }] },
  { id: 6, color: "#f4a261", title: "ধারা ৬: সাংগঠনিক কাঠামো", items: [{ sub: "", body: "সংগঠনের সাংগঠনিক কাঠামো হবে নিম্নরূপ:\nক) উপদেষ্টা পরিষদ\nখ) কার্যনির্বাহী পরিষদ" }] },
  { id: 7, color: "#e76f51", title: "ধারা ৭: উপদেষ্টা পরিষদ", items: [{ sub: "", body: "ক) নিশ্চিন্তপুর উচ্চ বিদ্যালয়ের ৩ জন শিক্ষক উপদেষ্টা পরিষদের সদস্য মনোনীত হবেন।\nখ) পদাধিকার বলে সভাপতি, সহ-সভাপতি উপদেষ্টা পরিষদে যুক্ত হবেন।" }, { sub: "ধারা ৭.১: উপদেষ্টা পরিষদ দায়িত্ব", body: "ক) বছরে অন্তত দুইবার উপদেষ্টা পরিষদ এবং কার্যনিবাহী পরিষদের মধ্যে যৌথসভা অনুষ্ঠিত হবে।\nখ) কার্যনির্বাহী পরিষদকে উপদেষ্টা পরিষদ যে কোন সমস্যা সমাধানে সর্বোচ্চ সাহায্য প্রদান করবেন।\nগ) নির্বাচন কমিশনের দায়িত্বে উপদেষ্টা পরিষদ থাকবেন।" }] },
  { id: 8, color: "#2196f3", title: "ধারা ৮: কার্যনির্বাহী পরিষদ", items: [{ sub: "", body: "ক) সংগঠনের সদস্যদের কর্তৃক মনোনিত শিক্ষার্থীদের নিয়ে সম্মিলিত কার্যনির্বাহী পরিষদ গঠিত হবে।\nখ) কার্যনিবাহী পরিষদ বছরে কমপক্ষে ৩টি সভা করবে, প্রয়োজন সাপেক্ষে সভা আরো বেশিও পরিচালনা করতে পারে।\nগ) কার্যনিবাহী পরিষদের কমপক্ষে এক তৃতীয়াংশ সদস্যের উপস্থিতি থাকলেই সভা পরিচালিত হবে।\nঘ) কার্যনির্বাহী পরিষদের সকল সিদ্ধান্ত উপস্থিত সংখ্যাগরিষ্ঠ সদস্যদের ভোট বা সমর্থনে গৃহীত হবে।\nঙ) প্রতি বছর কার্যনিবাহী পরিষদের সদস্য নির্বাচন অনুষ্ঠিত হবে, বর্তমানে সংগঠনের সদস্যদের ভোটের উপর নির্ভর করে। কোনো ব্যক্তি তিনবারের বেশি সভাপতিত্ব বা সহ সভাপতিত্ব করতে পারবে না। সভাপতি, সহ-সভাপতি এবং সাধারণ সম্পাদক কোন ক্রমেই রাজনীতির সাথে সম্পর্কিত থাকতে পারবেন না।\nচ) যেহেতু সভাপতি এবং সহ-সভাপতি তিনবারের বেশি নির্বাচন করতে পারবে না তাই তারা সফলতার সাথে দায়িত্ব পালন শেষ করে পদাধিকার বলে উপদেষ্টা পরিষদে যুক্ত হবে।" }] },
  { id: 9, color: "#43aa8b", title: "ধারা ৯: কার্যনির্বাহী পরিষদের নির্বাচন", items: [{ sub: "", body: "১। প্রতি এক বছর পর পর কার্যনির্বাহী পরিষদের নির্বাচন অনুষ্ঠিত হবে এবং যে কোন পদের প্রার্থী হতে হইলে তাকে অবশ্যই ভোটার হতে হবে।\n২। নির্বাচন কমিশন কার্যনির্বাহী কমিটির সহযোগিতায় ভোটার তালিকা প্রণয়ন করে সকলের অবগতির জন্য প্রকাশ করবেন।\n৩। নির্বাচন কমিশনের দায়িত্বে উপদেষ্টা পরিষদ থাকবেন। সহযোগিতার জন্য কার্য নির্বাহী পরিষদের বাহিরে সাধারণ সদস্যরা থাকবেন।\n৪। নির্বাচন সংক্রান্ত বিষয়ে নির্বাচন কমিশনের রায়ই চূড়ান্ত বলে গণ্য হবে।\n৫। কার্য নির্বাহী পরিষদের মেয়াদ উত্তীর্ণ হওয়ার কমপক্ষে ১৫ দিন পূর্বে নির্বাচন সম্পন্ন করে ফলাফল ঘোষনা করতে হবে। নির্বাচনের ফলাফল ঘোষনার ১৫ দিনের মধ্যে বিদায়ী কার্যনির্বাহী কমিটি নব-নির্বাচিত কার্য নির্বাহী কমিটিকে দায়িত্ব বুঝিয়ে দিবেন।" }] },
  { id: 10, color: "#e63946", title: "ধারা ১০: অনাস্থা প্রস্তাব", items: [{ sub: "ক. অনাস্থা প্রস্তাব আনার প্রক্রিয়া", body: "কার্যনির্বাহী কমিটির বিরুদ্ধে অনাস্থা প্রস্তাব আনার জন্য কমপক্ষে দুই-তৃতীয় সাধারণ সদস্যকে লিখিতভাবে প্রস্তাব দিতে হবে। এই লিখিত প্রস্তাব সভাপতি এবং উপদেষ্টাদের নিকট প্রদান করতে হবে। সভাপতি নোটিশ প্রাপ্তির পর সাধারণ সভা আহ্বান করবেন।" }, { sub: "খ. অনাস্থা প্রস্তাব পাসের শর্ত", body: "সাধারণ সভায় মোট সদস্য সংখ্যার তিন-চতুর্থাংশ সদস্য উপস্থিত থাকতে হবে। উপস্থিত সদস্যদের দুই-তৃতীয়াংশ ভোটে অনাস্থা প্রস্তাব পাস হবে।" }, { sub: "গ. অনাস্থা প্রস্তাব পাস হলে পরবর্তী ব্যবস্থা", body: "অনাস্থা প্রস্তাব পাস হলে, পরবর্তী ৩০ (ত্রিশ) দিনের মধ্যে নতুন কার্যনির্বাহী কমিটির নির্বাচন অথবা শূন্যপদ পূরণের ব্যবস্থা গ্রহণ করতে হবে।" }, { sub: "ঘ. সভাপতি সভা আহ্বান না করলে প্রস্তাবকারীদের অধিকার", body: "অনাস্থা প্রস্তাবের নোটিশ পাওয়ার ৩০ (ত্রিশ) দিনের মধ্যে যদি সভাপতি সাধারণ সভা আহ্বান না করেন, তবে অনাস্থা প্রস্তাবদাতা সাধারণ সদস্যরা নিজেরাই সাত (৭) দিনের নোটিশে সাধারণ সভা আহ্বান করতে পারবেন। সেই সভায় অনাস্থা প্রস্তাব পাস হলে, উক্ত সভায় কমপক্ষে ৫ (পাঁচ) জন সদস্যের একটি অন্তর্বর্তীকালীন/কেয়ারটেকার কমিটি গঠন করতে হবে। এই কমিটি ত্রিশ (৩০) দিনের মধ্যে নির্বাচন আয়োজনের ব্যবস্থা গ্রহণ করবে।" }] },
  { id: 11, color: "#6d6875", title: "ধারা ১১: সদস্য পদ বাতিল/স্থগিতের নিয়মাবলী", items: [{ sub: "", body: "ক) যদি কোন সদস্য স্বেচ্ছায় সঠিক ও উপযুক্ত কারণ দর্শানোপূর্বক লিখিত আকারে পদত্যাগ করেন।\nখ) যদি সংগঠনের গঠনতন্ত্র ও স্বার্থের পরিপন্থী কোন কাজ করেন বা তার স্বভাব আচার আচরণ সংস্থার পরিপন্থী হয়।\nগ) মৃত্যু বা মস্তিষ্ক বিকৃত ঘটলে।\nঘ) যদি কার্য নির্বাহী পরিষদের কেউ দায়িত্ব যথাযথ পালন না করলে তাহলে তাকে কার্য নির্বাহী পরিষদ থেকে বাদ দেওয়া হবে।\nঙ) সংগঠনের কোন সদস্য যদি শিক্ষা প্রতিষ্ঠান ও রাষ্ট্র বিরোধী কার্যকলাপে লিপ্ত হলে।\nচ) কার্য নির্বাহী পরিষদের কেউ যদি টানা তিন বার সভায় উপস্থিত না থাকে তাহলে তাকে কার্য নির্বাহী পরিষদ থেকে বাদ দেওয়া হবে।\nছ) আদালত কর্তৃক সাজাপ্রাপ্ত হলে।" }] },
  { id: 12, color: "#3a86ff", title: "ধারা ১২: সংগঠনের গ্রুপ এবং ফেসবুক পেজ সম্পর্কিত", items: [{ sub: "", body: "১. সংগঠনের গ্রুপে কোন ধরনের দুষ্টামি বা মজা করা যাবে না।\n২. যেকোন ধরনের মতামত প্রদান করা যাবে সংগঠন সম্পর্কিত।\n৩. গ্রুপে কোন ধরনের অশালীন ভাষা ব্যবহার করা যাবে না।" }] },
  { id: 13, color: "#ff6b6b", title: "ধারা ১৩: গঠনতন্ত্র পরিবর্তন, সংযোজন ও বিয়োজন", items: [{ sub: "", body: "সময়ের প্রয়োজনে যদি গঠনতন্ত্র পরিবর্তন, সংযোজন ও বিয়োজন এর প্রয়োজন হয়, তবে কার্যনির্বাহী পরিষদের মতামতের ভিত্তিতে তা করা যাবে। প্রয়োজনে সাধারণ সদস্যদের মতামত নেওয়া যেতে পারে এবং সংশোধন কমিটি গঠন করা যেতে পারে।" }] },
];
