...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { sub: "ক. অনাস্থা প্রস্তাব আনার প্রক্রিয়া", body: "কার্যনির্বাহী কমিটির বিরুদ্ধে অনাস্থা প্রস্তাব আনার জন্য কমপক্ষে দুই-তৃতীয় সাধারণ সদস্যকে লিখিতভাবে প্রস্তাব দিতে হবে। এই লিখিত প্রস্তাব সভাপতি এবং উপদেষ্টাদের নিকট প্রদান করতে হবে। সভাপতি নোটিশ প্রাপ্তির পর সাধারণ সভা আহ্বান করবেন।" },
      ...
      { sub: "গ. অনাস্থা প্রস্তাব পাস হলে পরবর্তী ব্যবস্থা", body: "অনাস্থা প্রস্তাব পাস হলে, পরবর্তী ৩০ (ত্রিশ) দিনের মধ্যে নতুন কার্যনির্বাহী কমিটির নির্বাচন অথবা শূন্যপদ পূরণের ব্যবস্থা গ্রহণ করতে হবে।" },
      { sub: "ঘ. সভাপতি সভা আহ্বান না করলে প্রস্তাবকারীদের অধিকার", body: "অনাস্থা প্রস্তাবের নোটিশ পাওয়ার ৩০ (ত্রিশ) দিনের মধ্যে যদি সভাপতি সাধারণ সভা আহ্বান না করেন, তবে অনাস্থা প্রস্তাবদাতা সাধারণ সদস্যরা নিজেরাই সাত (৭) দিনের নোটিশে সাধারণ সভা আহ্বান করতে পারবেন। সেই সভায় অনাস্থা প্রস্তাব পাস হলে, উক্ত সভায় কমপক্ষে ৫ (পাঁচ) জন সদস্যের একটি অন্তর্বর্তীকালীন/কেয়ারটেকার কমিটি গঠন করতে হবে। এই কমিটি ত্রিশ (৩০) দিনের মধ্যে নির্বাচন আয়োজনের ব্যবস্থা গ্রহণ করবে।" },
    ],
  },
  {
    id: 11, color: "#6d6875",
    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="container">
          ...
          <p className="hero-tagline">বন্ধুত্ব <span className="tagline-dot">•</span> একতা <span className="tagline-dot">•</span> স্বপ্ন</p>
